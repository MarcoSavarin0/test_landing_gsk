...
const ButtonThumbnail = ({name, img, data, active, alt}: VideoTestimonio) => {
	return (
		...
		>
			...
			<Image className="absolute object-cover object-top w-full h-44 top-0 left-0" alt={alt} src={`https://gsk-hdz-2.b-cdn.net/testimoniales/${img}.webp`} width={640} height={480}/>
