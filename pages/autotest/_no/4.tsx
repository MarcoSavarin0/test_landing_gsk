			...
			<div>
				...
				<article className="h-fit lg:h-[40rem] 2xl:h-[50rem] w-11/12 md:w-10/12 mx-auto about px-10 space-y-14 text-white rounded-xl">
					<div className="-mt-24 pt-8 space-y-5">
						...
						<p className="uppercase text-xl w-full md:w-10/12 lg:w-1/2 font-bold">¿Tu sistema inmune está comprometido? (Por ejemplo, por tratamientos médicos o uso de medicamentos que debilitan el sistema inmunitario)</p>

						<ul className="flex flex-wrap gap-x-2 gap-y-3">
							<li>
								<input type="radio" id="si" name="inmune" value="si" className="hidden peer" required />
							...
							<li>
								<input type="radio" id="no" name="inmune" value="no" className="hidden peer" required />
						...
						<div className="flex flex-wrap gap-x-2 gap-y-1">
							<Link href="/autotest/3" className="px-4 py-1 rounded-lg uppercase border border-white hover:border-white bg-gsk-dark hover:bg-white text-white hover:text-gsk-orange transition-colors duration-200">ATRÁS</Link>
							<Link href="/autotest/resultado" className="px-4 py-1 rounded-lg uppercase border border-gsk-orange hover:border-white bg-gsk-orange hover:bg-white text-white hover:text-gsk-orange transition-colors duration-200">FINALIZAR</Link>
						</div>
					</div>
				</article>
			</div>
