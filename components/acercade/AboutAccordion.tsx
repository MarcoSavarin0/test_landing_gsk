...
const faqs: Faq[] = [
	...
	{
		title: `¿SE PUEDE DESARROLLAR HERPES ZÓSTER SON HABER TENIDO VARICELA?`,
	...
	{
		title: `¿QUIENES PUEDEN TENER HERPES ZÓSTER?`,
	...
	},
	{
		...
		body: `<p>La fase aguda dura entre dos y cuatro semanas. El Herpes Zóster, a pesar de presentar una baja mortalidad, puede implicar complicaciones como por ejemplo la Neuralgia Posherpética, que es la más frecuente. Esta puede ocasionar discapacidad y afectar de forma importante a la calidad de vida de quienes viven con ella. La Neuralgia Posherpética se caracteriza por un dolor que puede ser de leve a insoportable, constante o intermitente, pudiendo persistir más de tres meses e incluso durar años <sup>7</sup>. Otras de las complicaciones, aunque menos frecuentes, son aquellas que pueden afectar a la visión con secuelas prolongadas o permanentes, que pueden dar lugar a la pérdida de la visión, complicaciones neurológicas y otros eventos como infartos o enfermedades cardiovasculares.</p>`
	}
	,
	{
		title: `¿CUÁLES SON LAS POSIBLES COMPLICACIONES QUE PUEDE TENER EL HERPES ZÓSTER?`,
		body: `<p>Si bien la mayoría de las personas se recupera por completo, algunas pueden experimentar mayores complicaciones. La complicación más común es la Neuralgia Posherpética (PHN, por sus siglas en inglés), un dolor neurálgico que persiste después de que la erupción se haya curado. La PHN puede durar de tres a seis meses, o incluso persistir por más tiempo. Suele ser más común y grave en personas mayores que en personas más jóvenes. Después de los 50 años, alrededor del 20 % de los pacientes con Herpes Zóster desarrollarán Neuralgia Posherpética.<br/><br/>Otras complicaciones también pueden incluir:<br/><ul><li>Cambios en la piel: cicatrices o cambios en la pigmentación después de que la erupción haya sanado.</li><li>Infección secundaria de la erupción de la culebrilla.</li><li>Herpes Zóster Oftálmico: ocurre cuando el virus infecta el nervio facial.</li><li>Complicaciones del sistema nervioso periférico y central.</li><li>Complicaciones cardiovasculares.</li><li>Impacto negativo en la calidad de vida.</li></ul></p>`
	}
	,
	{
	...
	,
	{
		title: `¿SE PUEDE TENER HERPES ZÓSTER MAS DE UNA VEZ?`,
