...
const VideoHero = ({type}: VideoHero) => {
	return (
		<div className="absolute bottom-auto md:bottom-0 md:left-0 w-full h-fit -mt-2 md:-mt-0">
			...
			<video className="w-full h-[27rem] md:h-auto object-cover md:object-contain object-top aspect-video -mt-20 md:mt-0 lg:-mt-10 xl:-mt-20 2xl:-mt-40 bg-gsk-dark" playsInline={true} crossOrigin="anonymous" preload="metadata" muted={true} width="1280" height="700" autoPlay={true} controls={false} loop={true}>
