...
const Conciencia = () => {
	return (
		<>
			...
			<>
				<section className="bg-[##FFFFFF] pb-20">
							...
							<div className="flex flex-col lg:flex-row gap-y-8 lg:gap-y-0 gap-x-8">
								<div className="space-y-8 w-full lg:w-7/12 xl:w-7/12 2xl:w-9/12">
									...
									<div className="space-y-6 text-justify">
										<p>En el marco de la Semana de Concientización del Herpes Zóster, que se celebra entre el 26 de febrero y el 3 de marzo, buscamos generar conciencia sobre los riesgos y el impacto de esta patología. Se calcula que más del 90% de los adultos mayores de 50 años, han sido infectados por el virus que causa la varicela y, por lo tanto, están en riesgo de que se reactive, desarrollando Herpes Zóster.</p>
				...
				<section className="w-full h-auto bg-[#00B8AC] pb-20">
					<div className="w-11/12 md:w-10/12 mx-auto about px-8 space-y-14 rounded-xl ">
						<h2 className="text-white font-bold text-2xl md:text-3xl pt-20">Queremos concientizar sobre qué es el Herper Zóster</h2>
				...
				<section className="w-full h-auto bg-[#F8F8F8] pb-20">
					<div className="w-11/12 md:w-10/12 mx-auto about px-8 space-y-14 rounded-xl">
						<h2 className="text-gsk-blue font-bold text-2xl md:text-3xl pt-20">Conocé sus principales síntomas:</h2>
				...
				<section className="w-full h-auto  pb-20">
					...
					<h2 className="text-gsk-black text-center font-bold text-2xl md:text-3xl pt-20">¿Estás en riesgo de desarrollar Herpes Zóster?</h2>
					...
					<div className="flex flex-col justify-center gap-y-5 items-center text-center pt-20">
						...
						<div className="flex flex-col md:flex-row justify-center items-center gap-x-0 sm:gap-x-2 gap-y-2">
							...
							<Link href="https://www.hablemosdezoster.com/autotest" onClick={() => va.track('Hz90-Cta-autotest')} className="text-base text-center text-white hover:text-gsk-blue bg-gsk-blue hover:bg-white border-2 border-transparent hover:border-gsk-blue transition duration-300 ease-out rounded px-8 py-3 uppercase font-bold">
