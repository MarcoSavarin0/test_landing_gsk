...
const VideoHero = ({type}: VideoHero) => {
	return ( /* -mt-10 md:mt-0 lg:-mt-8 xl:-mt-20 2xl:-mt-40 */
		<div className="absolute bottom-0 left-0 w-full h-fit">
			...
			<div className="absolute bottom-1 sm:bottom-2 md:bottom-3 lg:bottom-3 xl:bottom-5 2xl:bottom-6 left-0 w-full h-4 md:h-5 2xl:h-12 bg-gradient-to-t from-gsk-dark via-gsk-dark/60 to-gsk-dark/0 z-10"/>
		</div>
	)
}
