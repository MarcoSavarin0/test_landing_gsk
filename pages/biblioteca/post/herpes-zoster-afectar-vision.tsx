...
const DynamicSpeechBlog = dynamic(
  () => import("@/components/blog/SpeechBlog"),
  {
    ssr: false,
  }
);
    ...
    data: [
      {
        ...
        attributes: {
          ...
          metatitle:
            "¿Cómo el Herpes Zóster puede afectar la visión? | Blog | Hablemos de Zóster",
          metadescription:
            " Conocé el vínculo entre Herpes Zóster y la salud ocular. Aprendé sobre los riesgos, sus síntomas y cómo tratarlos. Cuidá tu salud.",
          slug: "note-slug",
...
const Blog = ({ nota }: any) => {
  const { title, image, metatitle, metadescription, slug } =
    nota.data[0].attributes;
    ...
    <>
      <NextSeo
        ...
        openGraph={{
          ...
          siteName:
            "Hablemos de Zóster | Campaña de concientización y prevención",
        }}
      />
            ...
            <article className="flex flex-col flex-1 gap-y-4 texto">
              <header className="space-y-6">
                ...
                <div className="space-y-1">
                  ...
                  <h1 className="text-gsk-orange font-bold leading-none text-4xl sm:text-5xl">
                    {title}
                  </h1>
