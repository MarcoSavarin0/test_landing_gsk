	...
	return (
		<section>
			<div className="relative w-full flex flex-col h-auto md:h-[27rem] lg:h-[34rem] xl:h-[40rem] 2xl:h-[44rem] bg-gsk-dark overflow-hidden">
				<video className="order-last md:order-first block w-full h-auto object-cover object-center aspect-video -mt-10 md:mt-0 lg:-mt-8 xl:-mt-20 2xl:-mt-40 " src="/assets/videos/hero.mp4" poster="/assets/images/hero.jpg" width="1280" height="700" autoPlay={true} controls={false} loop={true}>
				...
				<article className="order-first static md:absolute md:top-1/4 right-12 md:right-8 w-11/12 md:w-5/12 space-y-2 sm:space-y-4 px-6 md:px-0 pt-12 md:pt-0">
					...
					<p className={`${gskPrecisionLight} text-gsk-orange text-xl 2xl:text-3xl font-light`}>Conocé más sobre la enfermedad, sus síntomas <span className="block md:inline 2xl:block">y las opciones de prevención y tratamiento.</span></p>
				</article>
