        ...
        <>
          <div className="mx-auto max-w-8xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 items-center justify-between">
              ...
              <nav className="hidden sm:ml-6 lg:hidden xl:block">
                <div className="flex items-center">
                  <Link href="/#que-es-herpes-zoster" scroll={false} className="cursor-pointer text-white hover:text-gsk-orange hover:underline text-base md:text-sm lg:text-base xl:text-base px-2 uppercase transition ease-out duration-300">
                    ¿Qué es Herpes Zóster?
                  </Link>
                  <Link href="/#risk-who" scroll={false} className="cursor-pointer text-white hover:text-gsk-orange hover:underline text-base md:text-sm lg:text-base xl:text-base px-2 uppercase transition ease-out duration-300">
                    ¿Quiénes están en riesgo?
                  </Link>
                  <Link href="/enfermedades-cronicas" scroll={false} className="cursor-pointer text-white hover:text-gsk-orange hover:underline text-base md:text-sm lg:text-base xl:text-base px-2 uppercase transition ease-out duration-300">
                    Tengo una enfermedad crónica
                  </Link>
                  <Link href="/#enprimerapersona" scroll={false} className="cursor-pointer text-white hover:text-gsk-orange hover:underline text-base md:text-sm lg:text-base xl:text-base px-2 uppercase transition ease-out duration-300">
                    En primera persona
                  </Link>
                  <div className="relative" onMouseOver={handleMouseEnter} onMouseOut={handleMouseLeave}>
                    <div className="cursor-pointer text-white text-base md:text-sm lg:text-base xl:text-base px-2 uppercase transition ease-out duration-300 dropdown">
                      Iniciativas
                  ...
                  <Link href="/biblioteca" scroll={false} className="cursor-pointer text-white hover:text-gsk-orange hover:underline text-base md:text-sm lg:text-base xl:text-base px-2 uppercase transition ease-out duration-300">
                    Blog
                  </Link>
                </div>
              </nav>
          ...
          <Disclosure.Panel as="nav" className="lg:block xl:hidden">
