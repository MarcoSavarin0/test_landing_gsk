				...
				<div className="-mt-24 pt-8 space-y-6">
					<div className="text-center space-y-1">
						<div className="flex flex-wrap gap-x-2 justify-center items-end">
							<span className={`${score <= 1 ? `bg-gsk-orange` : `bg-gsk-gray`} w-4 md:w-5 h-4`}/>
						...
						<h3 className="uppercase text-xl md:text-2xl font-bold">{JSON.stringify(results[score].result)}</h3>
					</div>

					<div className="bg-white px-6 md:px-10 py-6 rounded-lg text-gsk-dark text-center space-y-6">
						<h3 className="text-xl"><span className="uppercase text-gsk-orange font-bold">
							{JSON.stringify(results[score].title).split('"').join('')}
						</span> de desarrollar Herpes Zóster.</h3>
