			...
			<>
				<section className="bg-[#00070C] pb-10">
					<div className="w-full h-auto">
						<video className={`w-full h-auto object-cover bg-gsk-dark`} playsInline={true} crossOrigin="anonymous" preload="none" muted={true} width="1920" height="600" autoPlay={true} controls={false} loop={true} poster={"data:image/jpeg;base64,"}>
