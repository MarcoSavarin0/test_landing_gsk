...
const ButtonThumbnail = ({name, data, active}: VideoTestimonio) => {
	return (
		<button className="group relative hover:shadow-lg transition ease-out duration-200 overflow-hidden w-full h-44 flex flex-col justify-center items-center rounded-xl px-4 md:px-6 py-8">
