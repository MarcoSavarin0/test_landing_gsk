		...
		<form onSubmit={handleSubmit(onHandleFormSubmit)} className="space-y-14">
			<div className="pt-8 space-y-5 lg:flex lg:flex-col lg:items-center lg:justify-center lg:space-y-7">
				<div className="lg:mb-6">
					...
					<div className="flex flex-wrap gap-x-1 justify-start items-center lg:w-full">
				...
				<p className="uppercase text-xl w-full sm:w-10/12 md:w-4/12 font-bold lg:text-center ">¿Tuviste varicela en algún momento de tu vida?</p>

				<ul className="flex flex-wrap gap-x-2 gap-y-3 lg:align-center lg:justify-center">
					<li>
